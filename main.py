...
###############Importlar bitti####################
#Burada Telegram Token, Wolfram Key ve Youtube API keylerini girin
...
def main():
  ...
  dp.add_handler(CommandHandler("help", yardim))
  dp.add_handler(CommandHandler("mp3", mp3))
  dp.add_handler(CommandHandler("mahrem", mahrem))
  dp.add_handler(CommandHandler("wiki", wiki))
  dp.add_handler(CommandHandler("ask", ask))
  dp.add_handler(CommandHandler("ymp3", ymp3))
  #Komut disi fonksiyonlari handle etmek icin kullanilacak fonksiyonu belirt
  dp.add_handler(MessageHandler(Filters.text, otherMessages))
